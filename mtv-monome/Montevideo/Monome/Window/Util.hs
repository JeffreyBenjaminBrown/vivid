...
notObscured allWindows (wtl, w) = f where
  ...
  obscures wRelative (wtl', w') = let
    absolute = pairSubtract wRelative wtl
    w'Relative = pairAdd absolute wtl' -- the Led, relative to w'
