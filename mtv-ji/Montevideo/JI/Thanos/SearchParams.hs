...
minFretsPerOctave, maxFretsPerOctave, max12edoFretSpan_lim7, max12edoFretSpan_lim13, minSpacingIn12edo :: Float
...
max12edoFretSpan_lim13 = 7 -- ^ Drop edos for which some 13-limit interval requires a stretch greater than this many frets of 12-edo.
