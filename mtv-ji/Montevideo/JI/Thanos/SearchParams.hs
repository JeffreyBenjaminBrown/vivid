...
minEdo = 12  -- ^ Don't consider any edos smaller than this.
maxEdo = 150 -- ^ Don't consider any edos bigger than this.
maxModulus = 12
...
minFretsPerOctave = 10 -- ^ when searching for guitars, this should probably be a small number. But for electronic instruments, big ones are fine -- maybe confusing, but certainly playable.
maxFretsPerOctave = 35
minSpacingIn12edo = 12/7
