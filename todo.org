* bug! dispatchLoop3 can't evaluate all of evs when I change mMuseqs3
** arc ! looks like the xproblem
*** what is period in arc?
*** why does this hang?
...
** another strategy: rather than forkIO to delete synths from the register, add a variable to Distrib3 that's like Museqs but for one-time instructions, to be evaluated next render
