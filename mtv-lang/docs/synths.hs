...
patMelody = -- A melody (in Hz).
  ...
  , (3.5, mfl [("freq",560)]) -- This note lasts half as long as the others:
  ]                           -- from time 3.5 to time 4.

-- Another melody. These frequencies are most naturally thought of as
...
-- Howeve,r patOctave and patMelody both control `freq`,
